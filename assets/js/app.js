...
import {hooks as colocatedHooks} from "phoenix-colocated/panko"
...
// Show progress bar on live navigation and form submits — amber to match Panko theme
topbar.config({barColors: {0: "#d4a017"}, shadowColor: "rgba(0, 0, 0, .3)"})
